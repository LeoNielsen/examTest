...
class HarbourResourceTest {
    ...
    private static Boat boat, boat1, boat2;
    ...
    void setUp() {
        ...
        boat2 = new Boat("bug", "2003", "queen", "ddd", new ArrayList<>(), null);
    ...
    void getBoats() {
        given()
                ...
                .when()
                .get("/harbour/{id}/allboats", harbour.getId()).then()
                .assertThat()
    ...
    void addBoat() {
        given()
                .contentType("application/json")
                .when()
                .put("/harbour/{hid}/addboat/{bid}", harbour.getId(), boat2.getId())
                .then()
                .assertThat()
                .statusCode(HttpStatus.OK_200.getStatusCode())
                .body("harbourID", equalTo(Integer.valueOf(String.valueOf(harbour.getId()))));
